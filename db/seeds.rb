...
company8 = Company.create!(name: "Bio C' Bon", city: "Lille", address: "45 rue Colbert", eco_scoring: 80,
                           ...
                           safe_space: true, remote: true)
company9 = Company.create!(name: "Psa Automobiles Sa", city: "Poissy", address: "2 Boulevard de l'europe",
                           eco_scoring: 25, social_scoring: 35, environmental_scoring: 20, logo_url: "psa.png",
                           accessibility: true, safe_space: false, remote: true)
company10 = Company.create!(name: "Electricité de France", city: "Paris", address: "222-30 Avenue de Wagram",
...
company12 = Company.create!(name: "Renault sas", city: "Boulogne-Billancourt", address: "13 Quai Alphonse le Gallo",
                            ...
                            accessibility: true, safe_space: true, remote: true)
company13 = Company.create!(name: "Orange", city: "Issy-les-Moulineaux", address: "111 quai du Président Roosevelt",
                            eco_scoring: 30, social_scoring: 5, environmental_scoring: 43, logo_url: "orange.png",
                            accessibility: true,  safe_space: false, remote: true)
...
offer3 = Offer.new(name: "Développeur Full Stack Ruby", description: "<strong>Dans le cadre d'un accroissement d'activité,
...
offer4 = Offer.new(name: "Développeur Full Stack", description: "<strong>Dans le cadre d'un accroissement d'activité,
                       vous rejoignez une équipe de 4-5 Développeurs (tous niveaux), pour travailler ensemble sur la
                       conception et/ou le développement de projets (sites vitrine, site web,...) pour les clients de
                       l'entreprise.</strong>
                       <br>
...
offer5 = Offer.new(name: "Développeur Back end", description: "<strong>Dans le cadre d'un accroissement d'activité,
                       vous rejoignez une équipe de 4-5 Développeurs (tous niveaux), pour travailler ensemble sur la
                       conception et/ou le développement de projets (sites vitrine, site web,...) pour les clients de
                       l'entreprise.</strong>
                       <br>
...
offer6 = Offer.new(name: "Social Media Manager", description: "<strong>Dans le cadre d'un accroissement d'activité,
                       vous rejoignez une équipe de 4-5 Développeurs (tous niveaux), pour travailler ensemble sur la
                       conception et/ou le développement de projets (sites vitrine, site web,...) pour les clients de
                       l'entreprise.</strong>
                       <br>
...
offer8 = Offer.new(name: "Content Manager", description: "Sous la responsabilité du Directeur Marketing, vous
                       serez en charge de l'animation des réseaux sociaux et du pilotage des campagnes de
                       sponsorisation, au service de la valorisation des contenus et des <br> comptes de nos clients.
                       <br> <br>
                       <strong>Compétences requises</strong> : <br><br>
                       ...
                       <strong>*</strong> Capacité à définir et animer une stratégie digitale ; <br><br>
                       <strong>*</strong> Expérience en gestion de campagnes emarketing - la maîtrise du Business Manager Facebook est
                       indispensable", income: 23_000, contract: "CDI")
...
wages = [30_000, 31_250, 30_500, 32_000, 35_000, 40_000, 45_000]
